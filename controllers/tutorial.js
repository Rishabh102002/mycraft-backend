...
tutorialRouter.get("/", async (request, response) => {
  const tutorials = await Tutorial.find({}).populate("user", {
    email: 1,
    name: 1,
    id: 1,
  });
...
tutorialRouter.post("/:id", async (req, res) => {
...
tutorialRouter.post("/", async (request, response) => {
...
tutorialRouter.delete("/:id", async (req, res) => {
...
tutorialRouter.put("/:id", async (req, response) => {
